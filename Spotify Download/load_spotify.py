...
bands_output.to_csv('/home/vagrant/nifi/bands.csv', index=False)
genres_output.to_csv('/home/vagrant/nifi/genres.csv', index=False)
albums_output.to_csv('/home/vagrant/nifi/albums.csv', index=False)